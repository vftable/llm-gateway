  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Center-anchored fade + zoom. The transform-origin stays centered so
        // the dialog grows from the middle rather than drifting toward a corner.
        "origin-center data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95",

  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Center-anchored fade + zoom, on the sidebar's snappy S-curve (this
        // panel opens/closes, same motion family as the sidebar's own
        // collapse). The transform-origin stays centered so the dialog grows
        // from the middle rather than drifting toward a corner.
        "origin-center duration-200 ease-sidebar",
